...
const supabaseUrl = 'https://hyjwnknzyfzpupdyiffe.supabase.co'
const supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imh5andua256eWZ6cHVwZHlpZmZlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjI4NTEzMDcsImV4cCI6MjAzODQyNzMwN30.TfYAdSF-mKh_4vy5Mm7pWA_ev5290iW-Jh_Qm4cRMqI'
  ...
  try {
    ...
    for (let i = 0; i < meals.length; i += batchSize) {
      ...
      if (error) {
        ...
        console.log(`✅ Batch ${Math.floor(i / batchSize) + 1}/${Math.ceil(meals.length / batchSize)} inserted (${successCount}/${meals.length})`)
      }
    ...
    console.log('\n✨ All done! You can now search for meals in the app.')
